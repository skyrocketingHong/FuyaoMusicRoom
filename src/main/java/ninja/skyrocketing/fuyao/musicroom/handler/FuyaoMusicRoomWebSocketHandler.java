...
@Component
@Slf4j
public class FuyaoMusicRoomWebSocketHandler extends WebSocketHandlerDecorator {

    @Autowired
    private FuyaoMusicRoomWebSocketHandlerAsync fuyaoMusicRoomWebSocketHandlerAsync;

    public FuyaoMusicRoomWebSocketHandler(WebSocketHandler delegate) {
        super(delegate);
    }
    ...
    public void afterConnectionEstablished(WebSocketSession session) throws Exception {
        fuyaoMusicRoomWebSocketHandlerAsync.afterConnectionEstablished(session);
